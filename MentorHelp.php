...
<center><h2>Mentor Help</h2></center><br/>

<p>A mentor is a professional who will help the students mentor through the project during the course of their project as part of their curriculum. They will be the ones who give the feedback to the performance of the students in the industry standards. </p><br/>
...
<a href="#viewproject"> 5. View your Projects </a><br/>
<a href="#pendingreq"> 6. Pending Requests </a><br/>
...
(g) Set of Documents to be submitted - You will be asked for the types of documents the student teams will submit during the duration of the project. If you do not see the options that you require in the list, please send a list of the documents to be added in the list to "support@zaireprojects.com". We will add the same.<br/>
(h) Select Programs - Please check those branches/programs for whom the project should be visible. If you do not view the branches/programs, please send a list of the same to "support@zaireprojects.com". We will ensure that they are added before you upload the project.<br/>
(i) Select Technologies - Please check the technologies which will be used for the projects. If you do not see the technologies, please send a list of the domains and subdomains to "support@zaireprojects.com". We will ensure that they are added and you can add the project.
...
(II) Document Status : This will help you the accept or reject the document submitted the The teams can only move to the next stage of document only if the current document is accepted.<br/>
