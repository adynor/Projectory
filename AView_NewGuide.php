<?php
    ...
    // Name            : Aview_newguide
    // Project         : Projectory
    // Purpose         : Admin views new guides in the portal and approve
    // Called By       : AHome
    // Calls           : AHome
    // Mod history:
    //////////////////////////////////////////////
...
<div class="container" >
 ...
 <?php
    ...
    {
        //check if there are any checked guides for confirmation
        if(isset ($_POST['l_UR_id_sel']))
        {
          ...
          //update confirmed state for the guides checked
    ...
    // get the information of the guides of pending status of the same institute
    $l_select_sql = 'Select UR.UR_id, UR.UR_FirstName, UR.UR_MiddleName, UR.UR_LastName, UR.UR_USN, UR.UR_Semester, UR.UR_Emailid, UR.UR_EmailidDomain from Users as UR where UR.UR_Type = "G" and UR.UR_RegistrationStatus = "P" and UR.IT_id =  '.$l_IT_id.' and Org_id="'.$_SESSION['g_Org_id'].'"';
          $l_result = mysql_query($l_select_sql);
          $l_UR_count = mysql_num_rows($l_result);
          ?>
            <div class="panel panel-primary">
  <!-- Default panel contents -->
  <div class="panel-heading"><h4 style="text-align:center">List Of New Guides</h4></div>
  <div class="panel-body table-responsive">
    ...
    {
        print ('<br><tr>');
        print('<td colspan=5  ><div class="alert alert-danger"><h4 style="text-align:center">There are no new Guides</h4></div></td></tr>');
