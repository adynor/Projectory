...
<div class="container">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            Users list
            <a style="margin-right: 13px; padding-right: 19px;" class="btn btn-small btn-success" href="javascript:void(0);" onclick="$('#importFrm').slideToggle();">Attach file</a>
            <a href="homeG.php">Go to Import Guides</a>
        </div>
