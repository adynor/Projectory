...
$l_query=mysql_query('select UR_FirstName,UR_MiddleName,UR_LastName,UR_Emailid,UR_EmailidDomain,UR_Phno,UR_Address,UR_City,UR_State,UR_Country,UR_Zipcode from Users WHERE UR_id="'.$l_UR_id.'"');
...
<table style="display:none;">
   ...
   <tr><td>Cancel Url	:</td><td><input type="hidden" name="cancel_url" value="https://zaireprojects.com/Projects.php" /></td></tr>
    ...
    <tr>
     ...
     <tr>
       <td>Merchant Param1 UR_id:</td><td><input type="text" name="merchant_param3" value="<?php echo $l_UR_id ;?>"/></td>
    </tr>
