...
$l_sql_mentor_details=  mysql_query('select UR_id ,UR_FirstName, UR_LastName, UR_Emailid, UR_EmailidDomain,UR_Phno from Users where UR_Type="M" and UR_id="'.$l_mentors_rows[0].'" and Org_id = "'.$l_TargetOrg_rows['TargetOrg'].'"' );
