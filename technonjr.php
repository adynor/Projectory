...
<thead    style=" background: rgb(51, 122, 183);
    color: white;
    " >
    <tr>
...
<th style="width:15%"> Project Duration </th>   
...
if($l_PR_count_res!=Null)
 ...
 $l_PR_count= mysql_num_rows($l_PR_count_res);    
                            ...
                            <td style="width:5%" ><?php echo $i; ?></td>
                              <td style="width:40%"><?php  echo $l_PR_Name; ?> <a  title="<u>Technologies Involved</u>" data-toggle="popover" data-trigger="hover" 
...
echo '<ul>';
 ...
 echo '</li>';
  ...
  <span class="glyphicon glyphicon-info-sign" ></span></a>
                               ...
                               <td style="width:15%"><?php echo $l_PR_Duration; ?>  Weeks</td>
